            ...
            <div className="container mt-5">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                        <div className="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Landscape Marketing Image</label>
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" />
                            </div>
                        ...
                        <div className="col">
                            <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Portait Marketing Image</label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" />
                        </div>
                        </div>
                        <div className="col">
                            <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Square Marketing Image</label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" />
                        </div>
                        </div>
                    </div>
